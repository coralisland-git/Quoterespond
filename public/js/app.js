...
(function () {
    ...
    function AppCtrl($scope, $rootScope, $window, $timeout, $location, $uibModal, request, $document) {
        ...
        $scope.menuClickHandler = function (page) {
            if (page.code.indexOf('reviews') == 0 && ! $scope.user.enable_review) {
                window.location.href = 'https://www.contractortexter.com/reviews';
            }
        };
    };
})();
