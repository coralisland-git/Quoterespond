<!DOCTYPE html>
<html data-ng-app="app" data-ng-controller="SignUpCtrl" ng-init="init()">
	<head>
		<meta charset="utf-8" />
									...
									<fieldset>
										...
										<div class="form-group">
											<div class="input-group input-group-first">
												...
												<select class="form-control input-lg" name="type" ng-model="signUp.type" ng-click="activeSelect = true" ng-class="{'active': activeSelect}" required="required">
													<option value="" disabled selected>Payment</option>
													<option value="yelp19">$19/mo</option>
													<option value="metered">$0.99 per Quote Request</option>
												</select>
											</div>
										</div>
										...
										<div class="form-group" style="text-align: justify;">
											...
											<a href="https://www.quoterespond.com/terms" target="_blank">{{ __('Terms') }}</a>
											{{ __('and') }}
											<a href="https://www.quoterespond.com/privacy" target="_blank">{{ __('Privacy') }}</a>
										</div>
